...
<main>
    ...
    <div id="profile-upper">
        <div id="profile-banner-image">
            <img src="{{asset('img/FotoProfil/'.$user->Foto)}}" style="width: 100%;height: fit-content;" alt="Banner image">
        </div>
        <div id="profile-d">
            <div id="profile-pic">
                @if($user->Foto)
                ...
                @elseif($user->Foto == "")
                <button type="button" class="btn d-flex justify-content-center align-items-center" data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color: white;width: 200px;height: 200px;">
                    <i class="fa-solid fa-plus" style="font-size: 50px;"></i>
                </button>
                @endif
            </div>
            @if($user->Foto)
            <button type="button" class="d-flex justify-content-center align-items-center" data-bs-toggle="modal" data-bs-target="#hapusProfile" style="background-color: white;width: 30px;height: 30px;position: absolute;bottom:0;left:170px;border-radius: 50%;">
            ...
            <div class="tb" id="m-btns">
                <div class="td">
                    <button class="m-btn" data-bs-toggle="modal" data-bs-target="#editProfil"><span><i class="fa-solid fa-user-pen me-1"></i>Edit Profil</span></button>
                </div>
                <div class="td">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 ms-4" id="exampleModalLabel">Ubah Profil</h1>
    ...
    <div class="modal fade" id="hapusProfile" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5 ms-4" id="exampleModalLabel">Hapus Profil</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/hapusProfile" method="post">
                        @csrf
                        <div class="">
